                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to BENEFITS Database Web App!</h1>
                                    </div>
                                    ...
                                    <form class="user" action="/login" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user @error('username') is-invalid @enderror"
                                                ...
                                                placeholder="Enter Username..." value="{{old('username')}}" autofocus required>
                                            @error('username')
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/register">Pengurus Forda? Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
