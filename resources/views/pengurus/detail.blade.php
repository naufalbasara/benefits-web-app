    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="/pengurus/edit/{{$p -> nrp}}" class="btn btn-sm btn-primary">Edit</a>
                |
                <a href="/pengurus/delete/{{$p -> nrp}}" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure You Want to Delete {{$p->nama}} From pengurus?')">Delete</a>
                @endforeach
