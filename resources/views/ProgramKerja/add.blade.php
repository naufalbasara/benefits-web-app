...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tambah Program Kerja</h1>
                ...
                <form action="/proker/store" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form-select-md" name="pengurusID" id="pengurusID">
                            <?php
                                $pengurusDivisi = $pengurus->where('pengurus.divisiID', '=', ''); //still confused how to get value from previous input
                            ?>
                            @foreach ($pengurus as $p)
                            <option value="{{$p -> pengurusID}}">{{$p -> nama}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-user" name="biaya" id="biaya" placeholder="Ex: 100000">
                    </div>

                    <div class="form-group">
                        <label class="control-label" for="namaProker">Nama Program</label>
                        <input type="text" class="form-control form-control-user" name="namaProker" id="namaProker" placeholder="Masukkan Program Kerja di sini" required>
                    </div>

                    <div class="form-group">
                        <label class="control-label" for="tanggalKegiatan">Tanggal Kegiatan</label>
                        <input type="date" class="form-control" name="tanggalKegiatan" id="tanggalKegiatan">
                      </div>
